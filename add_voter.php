...
<head>
    ...
    <style>
        ...
        .sidebar a {
            color: #fff; display: block; padding: 12px 20px; text-decoration: none; transition: background-color 0.3s;
        }
        .sidebar a:hover, .sidebar a.active { background-color: #495057; }
        .form-card { border-radius: 2-px; max-width: 800px; margin: 0 auto; }
        .form-section-title {
            font-weight: bold;
            font-size: 1.2rem;
            margin-bottom: 15px;
        ...
        .main-content { margin-left: 50px; padding: 20px 40px; }
...
<div class="container-fluid main-content">
    <div class="row">
        <div class="col-12">
            <h2 class="mb-4 fw-semibold text-center">📝 Voter Profiling Form</h2>
